    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follower_set', models.ManyToManyField(blank=True, related_name='user_follower_set', to=settings.AUTH_USER_MODEL)),
                ('following_set', models.ManyToManyField(blank=True, related_name='user_following_set', to=settings.AUTH_USER_MODEL)),
